...
--package=v2 \
--sub-structs='{"loggregator_v2.Envelope":"code.cloudfoundry.org/go-loggregator/v8/rpc/loggregator_v2"}' \
...
--imports='{"code.cloudfoundry.org/go-loggregator/v8/rpc/loggregator_v2":"loggregator_v2"}' \
