...
pubsub-gen \
--pointer \
--output=$GOPATH/src/code.cloudfoundry.org/loggregator-release/src/router/internal/server/v2/envelope_traverser.gen.go \
--package=v2 \
...
--struct-name=code.cloudfoundry.org/go-loggregator/v8/rpc/loggregator_v2.Envelope \
--imports='{"code.cloudfoundry.org/go-loggregator/v9/rpc/loggregator_v2":"loggregator_v2"}' \
