...
var _ = Describe("AppServiceCache", func() {
	var appServiceCache sinks.AppServiceWatcherCache
	var app1Service1, app1Service2, app2Service1 sinks.ServiceInfo

	BeforeEach(func() {
		appServiceCache = sinks.NewAppServiceCache()

		app1Service1 = sinks.NewServiceInfo("app-1", "syslog://example.com:12345", "org.space.app.1")
		app1Service2 = sinks.NewServiceInfo("app-1", "syslog://example.com:12346", "org.space.app.1")
		app2Service1 = sinks.NewServiceInfo("app-2", "syslog://example.com:12345", "org.space.app.1")
	...
	Describe("Size", func() {
		It("returns the total number of AppServices for all AppIds", func() {
			anotherAppService := sinks.NewServiceInfo("98765", "http://foo.com", "org.space.app.1")
