...
var file_dropsonde_protocol_events_metric_proto_goTypes = []any{
...
func file_dropsonde_protocol_events_metric_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_dropsonde_protocol_events_metric_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_dropsonde_protocol_events_metric_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_dropsonde_protocol_events_metric_proto_msgTypes[2].Exporter = func(v any, i int) any {
