...
The loggregator acceptance tests are intended to be run against a standalone loggregator deployment.
Use `scripts/generate-bosh-lite-manifest` to generate a manifest.
